...
var boxDiv = content.getElementsByClassName("box")[0];
var mainDiv = boxDiv.getElementsByClassName("control")[0];
var img2 = boxDiv.getElementsByClassName("img2")[0];
...
function move (index, limitX, limitY, minLength, element) {
  document.onmousemove = function (e) {
    switch (index) {
      case 0: leftMove(e, limitX, minLength); upMove(e, limitY, minLength); break;
      case 1: upMove(e, limitY, minLength); break;
      case 2: rightMove(e, minLength); upMove(e, limitY, minLength); break;
      case 3: rightMove(e, minLength); break;
      case 4: downMove(e, minLength); rightMove(e, minLength); break;
      case 5: downMove(e, minLength); break;
      case 6: leftMove(e, limitX, minLength); downMove(e, minLength); break;
      case 7: leftMove(e, limitX, minLength); break;
      case 8: allMove(e, limitX, limitY, element); break;
    }
    setChoice(element);
  }
